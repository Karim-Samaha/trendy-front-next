      ...
      <div className="border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden z-0">
        <div className="flex flex-col sm:flex-row items-start p-6 dir-rtl">
          ...
          <div className="sm:ml-8">
            ...
            <span className="uppercase">بيناتي</span>
              <svg
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="2.5"
        ...
        >
          ...
          <div className="max-w-lg">
            ...
            <Input className="mt-1.5" defaultValue={"+966-666-7744"} type={"tel"} />
          </div>
          <div className="max-w-lg">
            <Label className="text-sm">البريد الالكتروني</Label>
          ...
          <div>
            <Checkbox
              className="!text-sm"
              name="uudai"
              label="ارسال العروض عبر البريد الالكتروني"
              defaultChecked
            />
          </div>
